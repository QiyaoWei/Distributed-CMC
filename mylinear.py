...
from models.LinearModel import MyLinear, LinearClassifierAlexNet, LinearClassifierResNet
...
def get_train_val_loader(args):
    ...
    #Qiyao changed this, as well as the chunk sampler above
    #https://github.com/pytorch/vision/issues/168
    #NUM_TRAIN = 49000
    #NUM_VAL = 1000
    #train_dataset = datasets.CIFAR10("temp", transform=train_transform, download=True)
    #val_dataset = datasets.CIFAR10("temp", transform=val_transform, download=True)
    #train_sampler = None
    #train_loader = torch.utils.data.DataLoader(
    #    train_dataset, batch_size=args.batch_size, 
    #    num_workers=args.num_workers, pin_memory=True, sampler=ChunkSampler(NUM_TRAIN, 0))
    #val_loader = torch.utils.data.DataLoader(
    #    val_dataset, batch_size=args.batch_size,
    #    num_workers=args.num_workers, pin_memory=True, sampler=ChunkSampler(NUM_VAL, NUM_TRAIN))
...
def set_model(args):
    ...
    #Qiyao added this for multi GPU computing
    ...
    #classifier.to(f'cuda:{model.device_ids[0]}')
